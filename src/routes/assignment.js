...
import {
  ...
  verifyUserOnTeam,
  verifyUserHasPermissionsUpload
...
routes.post("/",  (req, res, next) => {
  ...
  upload.array("assignmentAttachments"),
  verifyUserHasPermissionsUpload,
...
routes.get("/:id_team/user/:id", verifyUserOnTeam, AssignmentController.getTeamUserAssignments); //receber as tarefas de uma equipe em especifico (do usuario), ok
routes.get("/get/:id_team/",
  (req, res, next) => {
    res.locals.permission = teamPermissions.moderator;
    res.locals.permissionApp = false;
    next();
  }, verifyUserHasPermissions, AssignmentController.getTeamAssignments); //receber as tarefas de uma equipe em especifico ok
routes.put("/:id",
  (req, res, next) => {
    res.locals.permission = teamPermissions.moderator;
    res.locals.permissionApp = false;
    next();
  }, verifyUserHasPermissionsAssignments, AssignmentController.update); //atualizar, NAO ok
routes.delete("/:id",
  (req, res, next) => {
    res.locals.permission = teamPermissions.moderator;
    res.locals.permissionApp = false;
  ...
  AssignmentController.destroy); //NAO OK
...
routes.get("/@me/team/:id_team/", AssignmentController.me, verifyUserOnTeam, AssignmentController.getTeamUserAssignments); //receber as tarefas de uma equipe em especifico, ok
routes.post(
